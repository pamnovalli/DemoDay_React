    ...
    return (
      <div className="App">
        ...
        <ContentSection 
          id={'project'} 
          title="O Projeto" 
          content="A Voluntarize é uma plataforma que disponibiliza um portfólio de Ongs e Comunidades que podem ser buscadas de acordo com os interesses e causas que inspirem o Voluntário. Na plataforma está acessível a descrição das ONGS e Comunidades, links para suas redes sociais e demais contatos para você se tornar um Voluntário. E Você também poderá criar e disponibilizar sua comunidade em nosso portfólio para que pessoas que tenham as mesma causas que você possam te encontrar. Com o voluntariado você poderá cumprir hora complementar na faculdade, ensinar os seus conhecimentos, ajudar uma causa, conseguir experiência para o currículo e  ainda conhecer pessoas legais."/>
        <ContentSection 
          id={'about'} 
          title="Quem Somos"
          content="Nossa Missão é divulgar as causas sociais e conectar as pessoas. Acreditamos que o Voluntariado pode ser o catalisador da união, e que pessoas unidas podem realizar grandes feitos.">
